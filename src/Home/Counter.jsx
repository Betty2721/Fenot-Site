...
export default function StatsSection() {
  return (
    <div className="w-full py-20 flex justify-center bg-[#0D164F]">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        {stats.map((item, i) => {
          ...
          return (
            <div
              key={i}
              className="relative group w-64 h-64 rounded-full border border-gray-400 flex flex-col justify-center items-center 
            ...
            >
              ...
              <div className="relative z-10 text-center">
                <Icon
                  className="mx-auto mb-3 text-white group-hover:text-[#F7D407]"
                  size={32}
                />
